...
library(maptools)
library(mapproj)
mydat=readShapeSpatial('~/data/map_data/bou2_4p/bou2_4p.shp')
...
city = read.csv(text = "name,long,lat
...
points(dat[1:10,]$jd, dat[1:10,]$wd, pch = 19, col = rgb(0, 0, 0, 0.5))
points(dat[11:20,]$jd, dat[11:20,]$wd, pch = 19, col = "blue")
