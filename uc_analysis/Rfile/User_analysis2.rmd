...
对于用户访问时长作的热力图，可以看出新老用户差距明显，新用户大部分日子访问时长接近白色，可能是今后的努力方向,11.11,11.12访问时间比较长,但之后明显回落
...
次日留存率，新用户并没有明显的波动，几乎保持水平，整体的波动几乎全部来源于老用户，老用户波动也很小,
11月12日注册的用户,留存率有个比较大的滑落
...
df = dcast(depth_p[,-4],fisnew~dt,value.var = "avg_depth")
rownames(df) = df[,1]
df = df[,-1]
...
本周加入排名相对前两周的变化，通过排名巨大变化可看出iphone5,iphone5c 有刷单嫌疑
...
上海作为新用户产生城市几乎是第二名贡献的2倍，可能有一定问题，京沪地区，长三角，仍然是最显著区域，东北地区沈阳的排名比上次有所提高，西北和中部地区仍然偏少，华南地区排名有所下降，成渝地区有所下降，清远和泉州有巨大提高，要么有活动，要么是刷单嫌疑
